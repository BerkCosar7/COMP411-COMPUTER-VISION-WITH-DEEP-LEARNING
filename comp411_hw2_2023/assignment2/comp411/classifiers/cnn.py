...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dout_affine1, grads['W3'], grads['b3'] = affine_backward(dout, cache_affine2)
        dout_conv, grads['W2'], grads['b2'] = affine_relu_backward(dout_affine1, cache_affine1)
        _, grads['W1'], grads['b1'] = conv_relu_pool_backward(dout_conv, cache_conv)
