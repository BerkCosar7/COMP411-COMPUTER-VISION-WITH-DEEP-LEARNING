...
def discriminator_loss(logits_real, logits_fake):
    ...
    fake_loss=bce_loss(logits_fake,torch.zeros_like(logits_fake).squeeze(1))
    real_loss=bce_loss(logits_real,torch.ones_like(logits_real).squeeze(1))
...
def generator_loss(logits_fake):
    ...
    loss=bce_loss(logits_fake,torch.ones_like(logits_fake).squeeze(1))
